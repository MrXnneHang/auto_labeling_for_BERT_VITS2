...
if __name__ == "__main__":
    ...
    biaozhu = [
        "./tmp/dataset_list/long_character_anno.txt",
    ...
    if os.path.exists("./tmp/dataset_list/long_character_anno.txt"):
        with open(
            "./tmp/dataset_list/long_character_anno.txt", "r", encoding="utf-8"
        ) as f:
    ...
    for index, rec in enumerate(rec_result):
        ...
        with open(
            "./tmp/dataset_list/long_character_anno.txt", "a", encoding="utf-8"
        ) as f:
            f.write(line1)
